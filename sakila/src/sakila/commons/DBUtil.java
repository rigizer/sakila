...
public class DBUtil {
	public Connection getConnection() throws Exception { // 데이터베이스 접근
		final String dbAddr = "jdbc:mariadb://rigizer.iptime.org:8106/sakila";	// 주소, 포트, 데이터베이스 이름
		final String dbId = "goodee";												// 데이터베이스 계정 ID
		final String dbPw = "java1004";											// 데이터베이스 계정 PW
